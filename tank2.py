...
class Tank2(pygame.sprite.Sprite):
    def __init__(self, tank_game, xy, direction):
        ...
        self.health = 10000
        self.armor = 0
        self.damage = random.randint(5000, 10000)
        self.missiles = 1000
        ...
        self.tank_game.all_tank2.add(self)
    ...
    def shot(self):
        if self.missiles > 0:
            ...
            Missile(self.tank_game, xy, self.direction, self.damage, "tank2", colors.RED)
    ...
    def checkMove(self):
        tank_check = Tank2(self.tank_game, self.rect.topleft, self.direction)
    ...
    def chooseField(self):
        ...
        moves.append((xy[0], xy[1]-self.tank_game.cell_size))
        enemy = self.getEnemy(self.tank_game.all_mytanks2)
        if enemy != None:
